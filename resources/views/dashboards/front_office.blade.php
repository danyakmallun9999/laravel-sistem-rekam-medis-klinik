    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mt-8 grid grid-cols-2 md:grid-cols-4 gap-6">
                <a href="{{ route('patients.create') }}" class="block p-5 bg-white border border-gray-200 rounded-xl hover:border-indigo-500 hover:shadow-md transition-all text-center group">
                    <div class="text-gray-400 group-hover:text-indigo-600 mb-2 transition-colors">
                        <svg class="w-8 h-8 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z"></path></svg>
                    </div>
                    <span class="block font-semibold text-gray-900 group-hover:text-indigo-600">Register New Patient</span>
                </a>
