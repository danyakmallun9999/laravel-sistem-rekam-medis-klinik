            ...
            <div>
                ...
                <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                    @foreach($medicalRecord->attachments as $path)
                        ...
                        @endphp
                        <a href="{{ asset('storage/' . $path) }}" target="_blank" class="group block p-4 border border-gray-200 rounded-xl hover:border-indigo-300 hover:shadow-md transition-all text-center bg-white overflow-hidden relative">
                            @if($isImage)
                                <div class="w-full h-32 mb-3 bg-gray-100 rounded-lg overflow-hidden">
