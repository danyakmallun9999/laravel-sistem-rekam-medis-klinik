        ...
        <form id="medical-record-form" action="{{ route('medical_records.update', $medicalRecord) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="space-y-8">
                ...
                <div class="bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
                    ...
                    <div class="mt-6">
                        ...
                        <div class="relative">
                            ...
                            <input type="datetime-local" name="visit_date" id="visit_date" value="{{ old('visit_date', $medicalRecord->visit_date ? $medicalRecord->visit_date->format('Y-m-d\TH:i') : '') }}" class="pl-10 mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 transition-colors" required>
                        </div>
                ...
                <div class="bg-red-50 p-6 rounded-xl border border-red-200 shadow-sm">
                    ...
                    <textarea name="allergies" id="allergies" rows="2" placeholder="List any known allergies..." class="mt-1 block w-full rounded-lg border-red-300 shadow-sm focus:border-red-500 focus:ring-red-500 transition-colors">{{ old('allergies', $medicalRecord->allergies) }}</textarea>
                </div>
                ...
                <div class="bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="responsible_person_name" id="responsible_person_name" value="{{ old('responsible_person_name', $medicalRecord->responsible_person_name) }}" class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 transition-colors">
                        </div>
                        <div>
                            <label for="responsible_person_relationship" class="block text-sm font-medium text-gray-700 mb-1">Relationship</label>
                            <input type="text" name="responsible_person_relationship" id="responsible_person_relationship" value="{{ old('responsible_person_relationship', $medicalRecord->responsible_person_relationship) }}" placeholder="e.g. Parent, Spouse" class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 transition-colors">
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
                        ...
                        <div class="bg-gray-50 p-3 rounded-lg border border-gray-100">
                            ...
                            <div class="relative">
                                <input type="number" name="vital_signs[systolic]" id="systolic" value="{{ old('vital_signs.systolic', $vs['systolic'] ?? '') }}" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm" placeholder="120">
                        ...
                        <div class="bg-gray-50 p-3 rounded-lg border border-gray-100">
                            ...
                            <div class="relative">
                                <input type="number" name="vital_signs[diastolic]" id="diastolic" value="{{ old('vital_signs.diastolic', $vs['diastolic'] ?? '') }}" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm" placeholder="80">
                                <span class="absolute right-3 top-2 text-xs text-gray-400">mmHg</span>
                            </div>
                        </div>
                        <div class="bg-gray-50 p-3 rounded-lg border border-gray-100">
                            ...
                            <div class="relative">
                                <input type="number" name="vital_signs[heart_rate]" id="heart_rate" value="{{ old('vital_signs.heart_rate', $vs['heart_rate'] ?? '') }}" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm" placeholder="72">
                        ...
                        <div class="bg-gray-50 p-3 rounded-lg border border-gray-100">
                            ...
                            <div class="relative">
                                <input type="number" name="vital_signs[respiratory_rate]" id="respiratory_rate" value="{{ old('vital_signs.respiratory_rate', $vs['respiratory_rate'] ?? '') }}" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm" placeholder="18">
                                <span class="absolute right-3 top-2 text-xs text-gray-400">bpm</span>
                            </div>
                        </div>
                        <div class="bg-gray-50 p-3 rounded-lg border border-gray-100">
                            ...
                            <div class="relative">
                                <input type="number" name="vital_signs[oxygen_saturation]" id="oxygen_saturation" value="{{ old('vital_signs.oxygen_saturation', $vs['oxygen_saturation'] ?? '') }}" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm" placeholder="98">
                        ...
                        <div class="bg-gray-50 p-3 rounded-lg border border-gray-100">
                            ...
                            <div class="relative">
                                <input type="number" step="0.1" name="vital_signs[temperature]" id="temperature" value="{{ old('vital_signs.temperature', $vs['temperature'] ?? '') }}" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm" placeholder="36.5">
                        ...
                        <div class="bg-gray-50 p-3 rounded-lg border border-gray-100">
                            ...
                            <div class="relative">
                                <input type="number" step="0.1" name="vital_signs[weight]" id="weight" value="{{ old('vital_signs.weight', $vs['weight'] ?? '') }}" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm" placeholder="70">
                        ...
                        <div class="bg-gray-50 p-3 rounded-lg border border-gray-100">
                            ...
                            <div class="relative">
                                <input type="number" name="vital_signs[height]" id="height" value="{{ old('vital_signs.height', $vs['height'] ?? '') }}" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm" placeholder="170">
                ...
                <div class="bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="bg-indigo-50/50 p-4 rounded-xl border border-indigo-100">
                            ...
                            <textarea name="soap_data[subjective]" id="subjective" rows="3" class="block w-full rounded-lg border-indigo-200 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 transition-colors" placeholder="Patient's complaints...">{{ old('soap_data.subjective', $soap['subjective'] ?? '') }}</textarea>
                        </div>
                        <div class="bg-indigo-50/50 p-4 rounded-xl border border-indigo-100">
                            ...
                            <textarea name="soap_data[objective]" id="objective" rows="3" class="block w-full rounded-lg border-indigo-200 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 transition-colors" placeholder="Physical exam findings...">{{ old('soap_data.objective', $soap['objective'] ?? '') }}</textarea>
                        </div>
                        <div class="bg-indigo-50/50 p-4 rounded-xl border border-indigo-100">
                            ...
                            <textarea name="soap_data[assessment]" id="assessment" rows="3" class="block w-full rounded-lg border-indigo-200 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 transition-colors" placeholder="Working diagnosis...">{{ old('soap_data.assessment', $soap['assessment'] ?? '') }}</textarea>
                        </div>
                        <div class="bg-indigo-50/50 p-4 rounded-xl border border-indigo-100">
                            ...
                            <textarea name="soap_data[plan]" id="plan" rows="3" class="block w-full rounded-lg border-indigo-200 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 transition-colors" placeholder="Treatment plan...">{{ old('soap_data.plan', $soap['plan'] ?? '') }}</textarea>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="bg-gray-50 p-6 rounded-xl border-2 border-dashed border-gray-300 text-center hover:bg-gray-100 transition-colors cursor-pointer relative">
                        ...
                        <div class="space-y-2 pointer-events-none">
                            ...
                            <div class="text-sm text-gray-600">
                                <span class="font-medium text-indigo-600 hover:text-indigo-500">Upload new files</span> or drag and drop
                            </div>
                ...
                <div class="bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="bg-blue-50 p-4 rounded-xl border border-blue-100">
                            ...
                            <div class="flex gap-2">
                                <input type="text" name="icd10_code" id="icd10_code" value="{{ old('icd10_code', $medicalRecord->icd10_code) }}" placeholder="Code (e.g. A00.0)" class="block w-1/3 rounded-lg border-blue-200 shadow-sm focus:border-blue-500 focus:ring-blue-500 transition-colors">
                                <input type="text" name="icd10_name" id="icd10_name" value="{{ old('icd10_name', $medicalRecord->icd10_name) }}" placeholder="Diagnosis Name" class="block w-2/3 rounded-lg border-blue-200 shadow-sm focus:border-blue-500 focus:ring-blue-500 transition-colors">
                            </div>
                        </div>
                        <div class="bg-blue-50 p-4 rounded-xl border border-blue-100">
                            <label for="icd9_code" class="block text-sm font-bold text-blue-900 mb-2">ICD-9-CM Code (Procedure)</label>
                            <div class="flex gap-2">
                                <input type="text" name="icd9_code" id="icd9_code" value="{{ old('icd9_code', $medicalRecord->icd9_code) }}" placeholder="Code (e.g. 89.01)" class="block w-1/3 rounded-lg border-blue-200 shadow-sm focus:border-blue-500 focus:ring-blue-500 transition-colors">
                                <input type="text" name="icd9_name" id="icd9_name" value="{{ old('icd9_name', $medicalRecord->icd9_name) }}" placeholder="Procedure Name" class="block w-2/3 rounded-lg border-blue-200 shadow-sm focus:border-blue-500 focus:ring-blue-500 transition-colors">
                            </div>
                        </div>
                    </div>
                    <div class="mt-4 bg-yellow-50 p-4 rounded-lg border border-yellow-100">
                        <label class="flex items-center">
                            <input type="checkbox" name="informed_consent_signed" value="1" {{ old('informed_consent_signed', $medicalRecord->informed_consent_signed) ? 'checked' : '' }} class="rounded border-yellow-400 text-yellow-600 shadow-sm focus:border-yellow-300 focus:ring focus:ring-yellow-200 focus:ring-opacity-50 w-5 h-5">
                ...
                <div class="bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <input type="text" name="diagnosis" id="diagnosis" value="{{ old('diagnosis', $medicalRecord->diagnosis) }}" class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 transition-colors" required>
                        </div>

                        <div>
                            <label for="treatment" class="block text-sm font-medium text-gray-700 mb-1">Treatment (Summary)</label>
                            <textarea name="treatment" id="treatment" rows="3" class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 transition-colors" required>{{ old('treatment', $medicalRecord->treatment) }}</textarea>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <select name="discharge_status" id="discharge_status" class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 transition-colors">
                                ...
                                <option value="Sembuh" {{ old('discharge_status', $medicalRecord->discharge_status) == 'Sembuh' ? 'selected' : '' }}>Sembuh</option>
                                <option value="Perbaikan" {{ old('discharge_status', $medicalRecord->discharge_status) == 'Perbaikan' ? 'selected' : '' }}>Perbaikan</option>
                                <option value="Rujuk" {{ old('discharge_status', $medicalRecord->discharge_status) == 'Rujuk' ? 'selected' : '' }}>Rujuk</option>
                                <option value="Pulang Paksa" {{ old('discharge_status', $medicalRecord->discharge_status) == 'Pulang Paksa' ? 'selected' : '' }}>Pulang Paksa</option>
                                <option value="Meninggal" {{ old('discharge_status', $medicalRecord->discharge_status) == 'Meninggal' ? 'selected' : '' }}>Meninggal</option>
                            </select>
                        </div>
                        <div id="referral_hospital_div" class="{{ old('discharge_status', $medicalRecord->discharge_status) == 'Rujuk' ? '' : 'hidden' }}">
                            <label for="referral_hospital" class="block text-sm font-medium text-gray-700 mb-1">Referral Hospital (RS Rujukan)</label>
                            <input type="text" name="referral_hospital" id="referral_hospital" value="{{ old('referral_hospital', $medicalRecord->referral_hospital) }}" class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 transition-colors">
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-indigo-50 p-6 rounded-xl border border-indigo-200 shadow-sm">
                    <label class="flex items-start cursor-pointer">
                        <input type="checkbox" name="is_signed" value="1" {{ old('is_signed', $medicalRecord->is_signed) ? 'checked' : '' }} required class="mt-1 rounded border-indigo-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 w-5 h-5">
                        <div class="ml-3">
                            ...
                            @if($medicalRecord->is_signed && $medicalRecord->signed_at)
                                <p class="text-xs text-indigo-700 mt-2 font-semibold flex items-center gap-1">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                                    Signed on: {{ $medicalRecord->signed_at->format('d M Y H:i') }}
                                </p>
                            @endif
                        </div>
                    </label>
