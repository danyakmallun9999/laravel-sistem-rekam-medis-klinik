    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white shadow-sm sm:rounded-lg overflow-hidden p-6 sm:p-8 space-y-8">
            ...
            <div class="pt-6 border-t border-gray-100 flex justify-end gap-3">
                ...
                <form action="{{ route('medical_records.destroy', $medicalRecord) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this record? This action cannot be undone.')">
                    @csrf
                    @method('DELETE')
